...
④는 렌더 스테이지 구현 완료(7/31)다. 그러나 **앱은 구현 0**이고 **③ YOLO 학습이
미착수**다. 크리티컬 패스는 여기서 시작한다.
...
| **잔여 — 휘도 노이즈(기준선 3배) 대응**: bf 파라미터 재조정 또는 A3 시간축 대체 | W1 과 연동 | 💻 | [6-5-2의 3](lowlight_classical.md) |
