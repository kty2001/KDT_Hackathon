...
| 작업 | 담당 | 환경 |
|------|------|------|
| 🆕 🔴 **배포 conf 계약 정정** — 확정 운영값은 **0.25**(`C4e` S1)인데 배포 패키지는 **0.35** 다(`metadata.json` · 패키지 `README.md` · `export_onnx.py` · `pipeline_demo.py`). ⚠️ 0.25 라 적힌 `readme_c4e_640.md` 는 **zip 밖**이라 앱팀이 받는 문서는 0.35 만 말한다. 스크립트 기본값 정정은 지금, **재내보내기는 `c4e_s3_11n/weights/best.pt` 이관 후** | 팀장 | 💻 |
