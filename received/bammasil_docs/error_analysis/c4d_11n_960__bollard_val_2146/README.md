...
- 가중치 `outputs/detect/c4d_11n_960/weights/best.pt`
- 평가셋 `outputs/datasets/bollard_val_2146/data.yaml` · 이미지 2,146장
- conf 0.25 · IoU 0.5 · imgsz 960
...
| 클래스 | FN | 사유별 |
|---|---|---|
| person | 1,088 | nearmiss 56 (5%) · lowconf 636 (58%) · merged 165 (15%) · blind 231 (21%) |
| bollard | 1,902 | nearmiss 106 (6%) · lowconf 1031 (54%) · merged 76 (4%) · blind 689 (36%) |
...
| 클래스 | FP | 사유별 |
|---|---|---|
| person | 680 | dup 139 (20%) · nearmiss 107 (16%) · confusion 7 (1%) · ghost 427 (63%) |
| stairs | 2 | ghost 2 (100%) |
| bollard | 1,143 | dup 200 (17%) · nearmiss 174 (15%) · confusion 4 (0%) · ghost 765 (67%) |
